...
local mappings = {
  ...
  ---quick split and nav
  { "<leader>-", act.SplitHorizontal { domain = "CurrentPaneDomain" }, "hsplit" },
  { "<leader>\\", act.SplitVertical { domain = "CurrentPaneDomain" }, "vsplit" },
  { "<leader>h", act.ActivatePaneDirection "Left", "move left" },
  { "<leader>j", act.ActivatePaneDirection "Down", "mode down" },
